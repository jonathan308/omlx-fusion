...
try:
    ...
    from .memory_monitor import (
        ...
        estimate_deepseek_v4_kv_bytes_per_token,
    ...
    estimate_deepseek_v4_kv_bytes_per_token = None
...
class Scheduler:
    ...
    def __init__(
        ...
        try:
            ...
            logger.debug("DeepSeek prefill floor probe failed", exc_info=True)
    ...
    def _supports_skip_lm_head(self) -> bool:
        ...
        if supported is None:
            try:
                declared = getattr(self.model, "supports_skip_lm_head", None)
    ...
    def prewarm_prompt_tail(
        ...
        *,
        ...
        try:
            ...
            return result
        # The final token in a rendered chat prompt is the unstable generation
        # boundary for OpenWebUI-style clients: on the following turn it is
        # replaced by the prior assistant content. Materialize exactly one token
        # before it. This remains a conservative exact prefix for ordinary
        # completion clients too; they merely reprocess one extra token.
    ...
    def _set_model_info_for_monitor(self) -> None:
        ...
        try:
            ...
            if (
                ...
                and estimate_deepseek_v4_kv_bytes_per_token is not None
            ):
